...
public class ExhibitorController {
    ...
    @ResponseBody
    public BaseResponse getExhibitor(@RequestParam(value = "id", defaultValue = "-1") int id,
    ...
    @Repeat
    public UploadResponse uploadLogo(@RequestParam(value = "file", required = false) MultipartFile file) {
    ...
    @Repeat
    public UploadResponse uploadBanner(@RequestParam(value = "file", required = false) MultipartFile file) {
    ...
    @Repeat
    public UploadResponse uploadImage(@RequestParam(value = "file", required = false) MultipartFile file) {
