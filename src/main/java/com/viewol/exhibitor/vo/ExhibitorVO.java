...
public class ExhibitorVO {
    ...
    public String getInviteErUrl() {
        return inviteErUrl;
    }

    public void setInviteErUrl(String inviteErUrl) {
        this.inviteErUrl = inviteErUrl;
    }

    public String getCompanyErUrl() {
        return companyErUrl;
    }

    public void setCompanyErUrl(String companyErUrl) {
        this.companyErUrl = companyErUrl;
    }
}
